...
import com.bookmyshow.utils.DateUtils;
...
public class BaseUI {
	...
	private static final Logger logBase = LogManager
			.getLogger(com.bookmyshow.base.BaseUI.class);
	...
	public static String setUrl() throws IOException, NullPointerException
	{
		
		String url = prop.getProperty("url");
		System.out.println(url);
		System.out.println("********************************************************************");
			if(url.equalsIgnoreCase("https://in.bookmyshow.com/"))
			{
